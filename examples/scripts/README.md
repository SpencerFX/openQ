...
|---|---|---|
| `01_publish_and_query.q` | Default pipeline (`./scripts/startup.sh`) | The basic round trip: publish ticks onto the tickerplant, read them back through the gateway |
...
pipeline first (`./scripts/startup.sh`, ports 5010-5013). Keep `05`'s

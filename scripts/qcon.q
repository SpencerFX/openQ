...
//
// Usage (see scripts/qcon.sh for the rlwrap-wrapped launcher):
//   q scripts/qcon.q -name eq_m1_yfinance_rdb          / port1 (active)
//   q scripts/qcon.q -name eq_m1_yfinance_rdb.2         / port2 (standby)
//   q scripts/qcon.q -name eq_m1_yfinance_gw -host myhost.local
//   q scripts/qcon.q -list                              / print the registry, don't connect
//
//====================================================================
...
if[not `name in key args;
   -1 "Usage: q scripts/qcon.q -name <processName> [-host <host>]   (or -list to see every known name)";
   exit 1
  ];
...
if[0=count match;
   ...
   -1 "Run 'q scripts/qcon.q -list' to see every known name.";
   exit 1
  ];
row:first match;

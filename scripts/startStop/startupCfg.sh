#!/bin/bash
# scripts/startStop/startupCfg.sh
# Same platform as scripts/startStop/startup.sh (tp/rdb/hdb/gw quartet, background q
...
# ./scripts/startStop/shutdown.sh stops a platform started either way - the two
...
#
# Usage: ./scripts/startStop/startupCfg.sh
...
if ! command -v "$Q" > /dev/null 2>&1; then
  ...
  echo "Set Q_BIN to your q executable, e.g. Q_BIN=/path/to/q ./scripts/startStop/startupCfg.sh" >&2
  exit 1
fi

...
// library publishes into, plus the `pidstats table modules/mon/
// pidstat_poller.py publishes into. Same (timestamp, sym) convention as
...
//@desc
.oq.schema.tables:{[] `logs`pidstats};

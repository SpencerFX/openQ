//====================================================================
// Directory: modules/ingest/massive_stocks/cep.q
//
// About:
...
// would go once there's a real need for it - see modules/ingest/massive/fh.q for
// where the raw feed itself is parsed and mapped to this schema.
//
// Namespaces:
